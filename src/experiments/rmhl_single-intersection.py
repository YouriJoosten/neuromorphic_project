...
if __name__ == "__main__":
    ...
    prs.add_argument("-a", dest="alpha", type=float, default=0.01)
    ...
    prs.add_argument("-d", dest="decay", type=float, default=0.999)
    ...
    prs.add_argument("-runs", dest="runs", type=int, default=100) #########episodes#########
